...
namespace GameServer
{
    public class UniversalStream
    {
        ...
        public string Decode()
        {
            ...
            {
                throw new Exception("METHOD: Decode" + ex.StackTrace + ex.Message, ex.InnerException);
            }
        }
        ...
        public void WriteHandshake(string data)
        {
            ...
            {
                throw new Exception("METHOD: WriteHandshake" + ex.StackTrace + ex.Message, ex.InnerException);
            }
        }
        ...
        private byte[] EncodeMessageToSend(string message)
        {
            ...
            {
                throw new Exception("METHOD: EncodeMessageToSend" + ex.StackTrace + ex.Message, ex.InnerException);
            }
        }
